 ...
 * 1. That a valid TestData instance is correctly serialized to JSON and then deserialized back to an equivalent object.
...
class SerializationUtilsTest {
    ...
    fun `serialize and deserialize TestData successfully`() {
        ...
        val originalData = TestData(id = 42, message = "Hello, world!")

        // Act: Serialize the object to JSON.
        val jsonString = SerializationUtils.serializeMessage(originalData)
        // Then deserialize the JSON back into a TestData object.
